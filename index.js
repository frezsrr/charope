...
const {help3} = require('./charop/help3')
const {dono} = require ('./charop/dono')
const {comando} = require ('./charop/comando')
const {bot} = require ('./charop/bot')
	...
	case 'hidetag':
		...
		client.sendMessage(from, menu(prefix, sender), text, {quoted: mek})
				...
				case 'semoji':
					...
					break
      case 'help3':
		client.sendMessage(from, help3(prefix, sender), text, {quoted: mek})
                break
				case 'nulis': 
				case 'tulis': ini
					...
					break
      case 'bot':
kkkkk		client.sendMessage(from, bot(prefix, sender), text, {quoted: mek})                break
	case 'kbbi':
            client.updatePresence(from, Presence.composing) 
	      ...
	      tels = body.slice(6)
			...
			tels = body.slice(6)
               ...
               if (data.error) return reply(data.error)
                ...
                break
               case 'comando':
		client.sendMessage(from, comando(prefix, sender), text, {quoted: mek})
                break
				case 'tts':
